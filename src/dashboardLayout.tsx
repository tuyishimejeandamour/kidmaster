    ...
    return (
        <div className='max-w-screen-2xl flex w-full h-full'>
            <div className='w-20 ml-3 flex items-center justify-between flex-col'>
                <div className='w-full items-center flex flex-col'>
                    <button type="button" onClick={() => {
                        router('/');
                        setOnDashboard(true)
                    }} role="tab" aria-selected="false" id="Pivot37-Tab1"
                            className="relative outline-transparent text-sm font-normal border-0 rounded-2xl cursor-pointer text-center inline-block h-14 bg-transparent ml-0 mb-2 w-14 select-none hover:bg-white"
                            name="My Media" data-content="My Media xx" data-is-focusable="true" tabIndex={-1}>
            <span className="flex flex-wrap h-full justify-start items-center select-none"
                  data-automationid="splitbuttonprimary">
              <span className="flex relative w-full h-full ">
                <span
                    className="flex flex-1 flex-col items-center h-full max-w-full justify-center rounded select-none ">
                  <span
                      className="relative overflow-hidden fill-zinc-700 ml-0 flex-shrink-0 h-8 w-8 grid place-items-center rounded">
                    <i data-icon-name="ArrowUpload" aria-hidden="true" className="w-6 h-6 inline-block select-none">
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6  fill-gray-800" viewBox="0 0 24 24"><path
              ...
              <span className="flex relative w-full h-full ">
                <span
                  ...
                  <span
                      className="relative overflow-hidden fill-zinc-700 ml-0 flex-shrink-0 h-8 w-8 grid place-items-center rounded">
                    <i data-icon-name="ArrowUpload" aria-hidden="true" className="w-6 h-6 inline-block select-none">
                      <svg xmlns="http://www.w3.org/2000/svg" className="text-white w-6 h-6 fill-gray-800"
                           viewBox="0 0 24 24" width="24" height="24"><path
                          d="M11 11V5H13V11H19V13H13V19H11V13H5V11H11Z"></path></svg>
                    </i>
                  </span>
                </span>
              </span>
          ...
          <span className="flex flex-wrap h-full justify-start items-center select-none"
            ...
            <div
                className='flex-1 mb-2 flex flex-col  py-2 px-4 overflow-x-hidden  bg-[#ffffff0c] -mt-1 rounded-2xl mr-4 ml-2  h-[100%] dahboardContainer'>
                {children}
            </div>
        </div>
    )
