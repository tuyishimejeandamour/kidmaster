    ...
    return (
        <>
                    ...
                    <div className="grow flex relative">
                        <div className="grow ">
                            <div className="relative">
                                <div
                                    className="bg-[#2b303b] text-[#d5ced9] text-[12px] w-full border relative block p-0 rounded-sm border-[#444a57]">
                                    <div className="relative w-full h-full flex p-1 items-center ">
                                        ...
                                        <input id="commandInput" autoFocus={true} autoComplete="off"
                                               ...
                                               placeholder={`Search ${groupCommand === "action" ? "actions" : groupCommand == "variable" ? "variables" : "functions"} by name `}
                                               name='command'
                                               value={searchValue}
            ...
            <div className="h-full">
                <div
                    className="max-h-[402px] overflow-auto commands_overflow pb-1 outline-0 groupCommand-none relative w-full h-full whitespace-nowrap"
                    tabIndex={0} role="listbox" aria-label="Quick Input" data-keybinding-context="88"
                    id="quickInput_list" aria-activedescendant="list_id_29_0">
                    <div id="commandTap"
                         className="relative overflow-hidden min-h-[200px] py-0 px-2 h-full groupCommand-none whitespace-nowrap "
                         role="presentation">
                        {showShadow && <div className='h-[1px] w-full' id='shadowDiv'
                                            style={{boxShadow: "0 0 8px 2px #14151abd"}}/>}
                        {
...
function selectNode(toReturn: boolean = false) {
    ...
    return new Promise((resolve, reject) => {
        ...
        const modal = <ConfirmModal onFunction={handleFunction} toReturn={toReturn} onValue={onVariable}
                                    selectedNode={handleSelected} onCancel={handleCancel}/>;
