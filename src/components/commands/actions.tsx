                            ...
                            <div key={category} title={category} className={"font-semibold w-full flex flex-col"}>
                                ...
                                <div className='flex flex-wrap w-full gap-2 '>
                                    {items.map((item) => (
                                        ...
                                        >
                                <span className="flex flex-wrap h-full justify-start items-center groupCommand-none"
                                      data-automationid="splitbuttonprimary">
                                    <span className="flex relative w-full h-full ">
                                        <span
                                            className="flex flex-1 flex-col items-center h-full max-w-full justify-center rounded groupCommand-none ">
                                            <span
                                                ...
                                                <i data-icon-name="ArrowUpload" aria-hidden="true"
                                                   className="w-6 h-6 flex items-center justify-center groupCommand-none">
                                                    {
                                            ...
                                            <span
                                                className='align-middle flex items-center font-normal text-[10px] flex-1 text-left text-gray-400 groupCommand-none w-full px-1'>
                                                <Highlighter
