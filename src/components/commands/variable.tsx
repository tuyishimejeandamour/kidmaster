...
const VariableComands: React.FC<{ onNodeClick: (Nodename: string, data?: Record<string, string>) => void }> = React.memo(({ onNodeClick }) => {
    ...
    const handleDelete = async (id:string) => {
        const answer = await confirm("delete "+id)
        if(answer){
            deleteVariable(id)
        }
    }
...
export default VariableComands
