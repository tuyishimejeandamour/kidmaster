...
import {useVariableStore, VariableItem, variableTypes} from '../../visualeditor';
...
export const VariableForm: React.FC<{
    ...
    const [variables, setVariables] = useState({
        ...
        type: chechtype(props.initialValues?.type),
        ...
        <div>
            <div className="relative w-full h-full flex gap-2 p-1 my-2 items-center ">
                ...
                <input autoFocus={true}
                       className="bg-inherit flex-1 w-[calc(100%-0px)] inline-block h-full  rounded-sm  border border-[#373b44] resize-none px-1 py-[6px] text-ellipsis "
            ...
            <div className="relative w-full h-full gap-2 flex p-1 my-2 items-center ">
                ...
                <select defaultValue={props.initialValues?.type}
                        className={"flex-1 h-8 px-1 rounded-sm text-sm !bg-[#373b44]"} onChange={(e) => {
...
const VariableCommands: React.FC<{
                                ...
                                <div>
                                    ...
                                    <div className=''>
                                        {matchedVariable.map((item) => (
                                            <div key={`var-${item}`}
                                                 className='w-full px-2 mb-1 items-center py-1 bg-[#373b445b] flex '>
                                                <div className='flex-1'>
                                                    ...
                                                    />
                                                    <span
                                                        className='text-zinc-600'>{`{ ${variableMap[item].currentValue || variableMap[item].defaultValue} }`}</span>
                                                </div>
                                                ...
                                                <div className='w-8 h-8 flex items-center' title='delete variable'
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                         className="w-4 h-4 text-gray-300 hover:cursor-pointer hover:text-red-500"
                                ...
                                matchedVariable.length < 1 && (
                                    <div
                                        ...
                                        <div className='flex items-center gap-3 truncate'>
                                            <span
                                                className='capitalize text-[10px]'>place enter to create variable{` (space "type" space "defaultValue") `} </span>
                                        ...
                                        <div className=''>
                                            <svg xmlns="http://www.w3.org/2000/svg" className="text-white h-4 w-4 fill-white"
                    ...
                    create && (
                        <VariableForm
                            ...
                            initialValues={{
                                ...
                                type: searchValue.split(' ')[1] as any || variableTypes[0],
                                defaultValue: searchValue.split(' ')[2] || undefined
                            }}
                            submitLabel="Create"
