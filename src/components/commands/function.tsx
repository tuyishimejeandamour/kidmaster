...
const FunctionsComands: React.FC<{ onNodeClick: (Nodename: string, data?: Record<string, string>) => void }> = React.memo(({ onNodeClick }) => {
    ...
    return (
        <div className='flex flex-col w-full mt-4 '>
            ...
            <div className='bg-[#373b44] flex items-center justify-between text-[#d5ced9] px-4 h-9 text-[13px] w-full border border-transparent relative  p-0 rounded-sm '>
