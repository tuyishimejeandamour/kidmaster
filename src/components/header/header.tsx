    ...
    return (
        <div  className="h-11 drag-window rounded-t-sm flex items-center justify-between">
            ...
            <div className="flex items-center h-11">
                ...
                {
                    onDashboard && (
                        <div className="min-w-[300px] un-drag-window w-fit h-11 pl-3 flex  items-center">
                            <div className="rounded  h-7 my-2 flex px-2  items-center bg-[#66697277] backdrop-blur-md select-none ">
                                <span className="ml-2 text-white text-sm font-medium">
                                    ...
                                    {activeSpace.name !== "main" ? (
                                        <>
                                            <span className="text-[11px]">{' / '}</span>
                                            <span className="text-blue-300 text-sm cursor-pointer">{activeSpace.name.split("up_")[1].split("_")[0]}</span>
                                        </>
                                    ) : null
                                    }
                                </span>
