            ...
            <div className={`flex h-11 items-center`}>
                {
                    onDashboard && (
                        <>
                            <div
                                className="flex justify-center un-drag-window items-center bg-[#2b303b] h-8 mr-3 w-11 rounded-md shadow-md  text-xs text-white hover:cursor-pointer hover:border-transparent"
                                onClick={open}>
                                <svg className='h-4 w-4 fill-white' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path
                            ...
                            <div onClick={handleRun}
                                 className="flex un-drag-window  justify-center items-center bg-blue-500 h-8 w-11 rounded-lg text-sm shadow-sm shadow-blue-700 text-white hover:border-transparent hover:cursor-pointer">
                                <svg className='h-4 w-4' xmlns="http://www.w3.org/2000/svg" width="24" height="24"
