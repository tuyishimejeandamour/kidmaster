...
function Toolbar() {
    ...
    return (
        <ul data-tauri-drag-region className="flex  w-full  justify-center list-none">
            <li onClick={() => handleCreateNode("fetch")}
                className="w-11 h-11 flex items-center  hover:cursor-pointer hover:bg-[#34383b] justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5  text-white" width="24" height="24"
