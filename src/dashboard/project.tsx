...
export default function Project({project}: { project: ProjectStory}) {
    ...
    return (
        <div
            className="inner-container mb-[-1px] ml-[-1px] relative border  border-b-transparent border-blue-50/10 ">
            <div className="Card_container__rgpnr relative">
                    ...
                    <div className="relative w-full pb-[50%] md:pb-[65%]">
                        <div className="p-6 absolute inset-0">
                            <div
                                ...
                                <motion.div
                                    variants={title}
                                    className="font-mono text-3xl md:text-4xl uppercase text-white font-bold z-10"> {project.name}
                                </motion.div>
                                <div
                ...
                <motion.div variants={robot} className="p-6">
                    <div className="text-sm mb-3.5 text-white">
                        {project.description}
                    </div>
                    <div
