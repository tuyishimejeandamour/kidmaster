...
import {useConnectionStore, useStageStore} from '@/visualeditor';
...
export const FlowEditor: React.FC = React.memo(() => {
    ...
    return (
        <Allotment className="flex-1 w-full h-[calc(100vh-44px)] px-2 flex flex-wrap">
            ...
            <Allotment.Pane priority={LayoutPriority.Low} snap={true} maxSize={showSideEditor ? 305 : 0}
                            minSize={showSideEditor ? 305 : 0}>
