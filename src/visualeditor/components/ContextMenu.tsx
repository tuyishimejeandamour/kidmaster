                    ...
                    <ul className='w-full'>
                        {
                            selectedNodeIds[0] && selectedNodeIds[0].includes("group") && (
                                <li className='w-full bg-transparent select-none h-7 px-1 rounded-md flex items-center hover:cursor-pointer hover:bg-gray-300/50 '
                                    onClick={() => {
                                        setShowPopup(false)
...

            {
                contextMenu === "stage" && (
                    <ul className='w-full'>
                        ...
                        <li className='w-full bg-transparent h-7 px-1 rounded-md flex items-center hover:cursor-pointer hover:bg-gray-300/50 '
                            onClick={() => handleCreateNode('variable')}>
                        ...
                        <li className='w-full bg-transparent h-7 px-1 rounded-md flex items-center hover:cursor-pointer hover:bg-gray-300/50 '
                            onClick={() => handleCreateNode('function')}>
