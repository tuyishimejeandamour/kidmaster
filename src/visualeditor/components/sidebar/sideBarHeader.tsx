                                            ...
                                            groupCommand != "action" ?
                                                <span className='h-full text-center'>
                                                    {groupCommand == "variable" ?
                                                        (
                                                            <svg className="h-4 w-4 fill-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="5 3 19 12 5 21 5 3" style={{ borderRadius: 2 }}></polygon></svg>
