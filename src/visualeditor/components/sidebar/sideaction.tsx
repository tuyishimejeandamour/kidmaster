...
export default function SideActions() {
    ...
    return (
        <div role="tablist"
             className="flex flex-col rounded-lg py-2 bg-white/5 backdrop-blur-xl items-center shadow-sm shadow-slate-400/25"
            ...
            <Action onClick={() => save()} title="save">
                <svg xmlns="http://www.w3.org/2000/svg" focusable="false" viewBox="0 0 24 24" width="24" height="24">
                    <path
                        d="M7 19V13H17V19H19V7.82843L16.1716 5H5V19H7ZM4 3H17L21 7V20C21 20.5523 20.5523 21 20 21H4C3.44772 21 3 20.5523 3 20V4C3 3.44772 3.44772 3 4 3ZM9 15V19H15V15H9Z"></path>
                </svg>
            </Action>
