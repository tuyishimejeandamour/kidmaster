            ...
            <div className="flex flex-col items-center justify-center w-[62px]  bg-transparent  whitespace-nowrap">
                <div className='w-14 flex flex-col py-1 gap-1  items-center rounded-md bg-white/5 backdrop-blur-xl  mt-1 mb-1 h-full shadow-xl drop-shadow-xl'>
                    <button onClick={() => setGroupCommand("action")} className={`inline-flex items-center w-14 h-9 rounded-tl rounded-bl  text-xs text-center  bg-transparent border-l-4  ${groupCommand.includes("action") ? "text-blue-500 border-blue-500" : "text-gray-500  border-transparent"}    whitespace-nowrap cursor-base focus:outline-none hover:text-blue-400 hover:border-blue-400`}>
                        <span className='w-full flex justify-center items-center rounded h-full ' data-title={"actions"}>
                    ...
                    <button onClick={() => setGroupCommand("variable")} className={`inline-flex items-center rounded-tl rounded-bl w-14 h-9 text-xs text-center bg-transparent border-l-4  ${groupCommand.includes("variable") ? "text-blue-500 border-blue-500" : "text-gray-500  border-transparent"}   whitespace-nowrap cursor-base focus:outline-none hover:text-blue-400 hover:border-blue-400`}>
                        <span className='w-full flex justify-center items-center rounded h-full' data-title={"variable"}>
                            <svg className="h-[22px] w-[22px]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="5 3 19 12 5 21 5 3" style={{ borderRadius: 2 }}></polygon></svg>
                        </span>
                    </button>
                    <button onClick={() => setGroupCommand("function")} className={`inline-flex items-center rounded-tl rounded-bl  w-14 h-9 text-xs text-center ${groupCommand.includes("fun") ? "text-blue-500 border-blue-500" : "text-gray-500  border-transparent"}  bg-transparent border-l-4    whitespace-nowrap focus:outline-none hover:text-blue-400 hover:border-blue-400`}>
                        <span className='w-full flex justify-center items-center rounded h-full' data-title={"function"}>
                            Fun
                        </span>
                    </button>
                    <button onClick={() => setGroupCommand("console")} className={`inline-flex items-center rounded-tl rounded-bl  w-14 h-9 text-xs text-center ${groupCommand.includes("console") ? "text-blue-500 border-blue-500" : "text-gray-500  border-transparent"}  bg-transparent border-l-4    whitespace-nowrap focus:outline-none hover:text-blue-400 hover:border-blue-400`}>
                        <span className='w-full flex justify-center items-center rounded h-full' data-title={"console"}>
                            <svg className="h-[22px] w-[22px] fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M10.9999 11.9998L3.92886 19.0708L2.51465 17.6566L8.1715 11.9998L2.51465 6.34292L3.92886 4.92871L10.9999 11.9998ZM10.9999 18.9998H20.9999V20.9998H10.9999V18.9998Z"></path></svg>
                        </span>
                    </button>
