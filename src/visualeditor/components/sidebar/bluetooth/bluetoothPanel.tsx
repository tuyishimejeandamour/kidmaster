                        ...
                        if (device) {
                            return (
                                <li className="border-gray-400 w-full flex flex-row mb-2">
                                    <div
                                        className="select-none w-full cursor-pointer bg-gray-800/20 rounded-md flex flex-1 items-center p-4  transition duration-500 ease-in-out transform hover:-translate-y-1 hover:shadow-lg">
                                        <div
                                            className="flex flex-col rounded-md w-10 h-10 bg-gray-700 justify-center items-center mr-4">
                                            <svg className={"fill-slate-300 w-8 h-8"} xmlns="http://www.w3.org/2000/svg"
                                                 viewBox="0 0 24 24">
                                                <path
                                        ...
                                        <div className="flex-1 pl-1">
                                            <div className=" w-full truncate"><span
                                                className={"truncate font-medium"}>{device.deviceName}</span></div>
